...
MODEL = "gpt-4o"
DATABASE = "source.db"
USER_MESSAGE = "Hi, which country have been growing the most, look at the whole dataset?"
...
Table: Migration
Columns: index, Country, year, population, netMigration, population_in_millions
"""
